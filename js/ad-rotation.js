document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Desktop Ads ---
    try {
        if (typeof window.sidebarSmallRotatingAdsData1 !== 'undefined') {
            rotateAd(window.sidebarSmallRotatingAdsData1, 'rotating-ad-link-small-1');
        } else {
            console.log("sidebarSmallRotatingAdsData1 is undefined.");
        }

        if (typeof window.sidebarSmallRotatingAdsData2 !== 'undefined') {
            rotateAd(window.sidebarSmallRotatingAdsData2, 'rotating-ad-link-small-2');
        } else {
            console.log("sidebarSmallRotatingAdsData2 is undefined.");
        }

        if (typeof window.categorySpotlightAdsData !== 'undefined'
            && !window.location.pathname.endsWith('index.html')) {
            rotateAd(window.categorySpotlightAdsData, 'rotating-ad-link-category');
        } else {
            console.log("categorySpotlightAdsData is undefined or on index.html.");
        }
    } catch (e) {
